...
extern NODE *RSTART_node, *RS_node, *RT_node, *FL_node, *SUBSEP_node, *PROCINFO_node;
extern NODE *LINT_node, *ERRNO_node, *TEXTDOMAIN_node, *FPAT_node;
extern NODE *PREC_node, *ROUNDMODE_node;
extern NODE *Nnull_string;
extern NODE *Zero_numbr;
extern NODE *Nnull_binary;
...
enum do_flag_values {
	...
	DO_PCAP_LIVE    = 0x8000,       /* Do live pcap analysis */
	DO_PCAP_OFFLINE = 0x10000       /* Do offline pcap analysis */
};
...
#define do_pcap_offline     (do_flags & DO_PCAP_OFFLINE)
#define do_pcap_live        (do_flags & DO_PCAP_LIVE)
...
#define make_binary(s, l)       make_bin_node((s), (l), 0)
...
extern NODE **r_get_field(IOBUF *iop, NODE *n, Func_ptr *assign, bool reference);
/* ext.c */
...
extern NODE *make_bin_node(const char *s, size_t len, int flags);
