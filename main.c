...
NODE *Zero_numbr;               /* The global 0 number */
NODE *Nnull_binary;             /* The global null binary */
...
/*
 * PCAP analysis mode main struct.
 */
extern struct pcap_io PIO;
...
#undef STACK_SIZE
	...
	/* initialize the 0 number */
	Zero_numbr = make_number(0);
	/* initialize the null binary */
	Nnull_binary = make_binary(NULL, 0);
...
{&FL_node,        "FL",         "",     0,  NULL, NULL, false, NON_STANDARD },
...
parse_args(int argc, char **argv)
{
	 ...
	 */
	const char *optlist = "+F:f:v:W;bcCd::D::e:E:ghi:l:L:nNo::Op::MPrStVYZ:a::";
	int old_optind;
	int c;
	char *scan;
	char *src;
